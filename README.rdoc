...
* Same blue Search box as per yardoc.org, placed top-right
* Blue search box entirely replaces the 3 previous drop-down menus (Files List, Methods List, Class List), remember those?
* New search backend to power the search box (loads local file 'search_index.json')
